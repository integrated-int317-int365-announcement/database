...
-- -----------------------------------------------------
-- Table `announcement`.`categorys`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `announcement`.`categorys` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `announcement`.`announcements` (
  ...
  CONSTRAINT `fk_announce_category1`
    ...
    REFERENCES `announcement`.`categorys` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `announcement`.`annoucement_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `announcement`.`annoucement_group` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `announcement`.`announcement_topics`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `announcement`.`announcement_topics` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `list_no` INT NULL,
  `title` VARCHAR(45) NOT NULL,
  `description` VARCHAR(255) NULL,
...
-- -----------------------------------------------------
-- Table `announcement`.`announcement_topics_users`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `announcement`.`announcement_topics_users` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `list_no` INT NULL,
  `title` VARCHAR(45) NOT NULL,
  `description` VARCHAR(255) NULL,
  `announcement_topic_id` INT NOT NULL,
  `user_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `topic_id_UNIQUE` (`id` ASC) VISIBLE,
  INDEX `fk_announcement_sub_lists_announcement_lists1_idx` (`announcement_topic_id` ASC) VISIBLE,
  INDEX `fk_announcement_topics_users_users1_idx` (`user_id` ASC) VISIBLE,
  CONSTRAINT `fk_announcement_sub_lists_announcement_lists1`
    FOREIGN KEY (`announcement_topic_id`)
    REFERENCES `announcement`.`announcement_topics` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_announcement_topics_users_users1`
    FOREIGN KEY (`user_id`)
    REFERENCES `announcement`.`users` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
